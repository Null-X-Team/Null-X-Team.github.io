...
(function() {
    ...
    style.innerHTML = `
        ...
        .xhair-core { position:absolute; width:2px; height:2px; background:#e0e0e0; z-index:5; }
        .xhair-axis { position:absolute; background:rgba(220,220,220,0.85); }
        ...
        .xhair-ring-inner {
            position:absolute; width:22px; height:22px; border:1px solid rgba(200,200,200,0.5); border-radius:50%;
        }
        ...
        #unique-crosshair.text-input .xhair-core { width:2px; height:14px; background:#aaa; }
        #unique-crosshair.clicking .xhair-ring-inner { width:30px; height:30px; opacity:0.4; }
    `;
