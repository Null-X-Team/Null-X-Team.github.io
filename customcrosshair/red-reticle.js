...
(function() {
    ...
    style.innerHTML = `
        ...
        .xhair-core { position:absolute; width:4px; height:4px; background:#ff3333; border-radius:50%; box-shadow:0 0 8px #ff0000; z-index:5; transition:all 0.12s; }
        .xhair-ring-inner { position:absolute; width:20px; height:20px; border:2px solid rgba(255,50,50,0.7); border-radius:50%; transition:all 0.18s; }
        .xhair-ring-outer { position:absolute; width:40px; height:40px; border:1px solid rgba(255,50,50,0.35); border-radius:50%; transition:all 0.2s; }
        .xhair-axis { position:absolute; background:rgba(255,60,60,0.9); box-shadow:0 0 4px #ff0000; transition:all 0.15s; }
        ...
        #unique-crosshair.text-input .xhair-core {
            width:2px; height:18px; border-radius:1px; background:#ff8888;
            animation: redBlink 0.9s step-end infinite; box-shadow:0 0 6px #ff4444;
        }
        #unique-crosshair.text-input .xhair-ring-inner,
        #unique-crosshair.text-input .xhair-ring-outer,
        #unique-crosshair.text-input .xhair-axis { opacity:0; transform:scale(0.3); }
        @keyframes redBlink { 0%,100%{ opacity:1; } 50%{ opacity:0; } }
        #unique-crosshair.clicking .xhair-core { background:#fff; transform:scale(2.2); box-shadow:0 0 20px #ff0000; }
        #unique-crosshair.clicking .xhair-ring-inner { width:48px; height:48px; border-color:#ff0000; opacity:0.3; }
        #unique-crosshair.clicking .xhair-ring-outer { width:72px; height:72px; border-color:#ff6666; opacity:0.15; }
        #unique-crosshair.clicking .xhair-axis { opacity:0; }
    `;
