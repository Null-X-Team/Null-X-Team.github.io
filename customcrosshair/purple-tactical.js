...
(function() {
    ...
    style.innerHTML = `
        ...
        .xhair-core {
            position:absolute; width:6px; height:6px; background:#b44dff;
            transform:rotate(45deg); box-shadow:0 0 10px #8b00ff; z-index:5;
        }
        .xhair-axis { position:absolute; background:rgba(180,80,255,0.85); box-shadow:0 0 4px #8b00ff; }
        ...
        .xhair-bracket-container { position:absolute; width:56px; height:56px; }
        .xhair-bracket {
            position:absolute; width:11px; height:11px; border:2px solid #8b00ff;
        ...
        #unique-crosshair.text-input .xhair-core { background:#c080ff; border-radius:50%; transform:none; }
        #unique-crosshair.clicking .xhair-core { transform:rotate(225deg) scale(1.7); background:#ff66ff; }
    `;
