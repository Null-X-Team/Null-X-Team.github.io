/**
 * Null_X Crosshair Style — cyan-hud (alt)
 */
(function() {
    ...
    style.innerHTML = `
        ...
        .xhair-core { position:absolute; width:6px; height:6px; background:#00ffcc; transform:rotate(45deg); box-shadow:0 0 10px #00ffcc; z-index:5; transition:all 0.15s; }
        .xhair-ring-inner { position:absolute; width:24px; height:24px; border:2px dotted rgba(0,255,204,0.6); border-radius:50%; animation:spinR 8s linear infinite; transition:all 0.2s; }
        .xhair-ring-outer { position:absolute; width:44px; height:44px; border:1px dashed rgba(0,255,204,0.4); border-radius:50%; animation:spinN 12s linear infinite; transition:all 0.2s; }
        .xhair-axis { position:absolute; background:rgba(0,255,204,0.8); box-shadow:0 0 5px #00ffcc; transition:all 0.12s; }
        ...
        #unique-crosshair.text-input .xhair-core {
            width:2px; height:16px; transform:none; border-radius:0; background:#00ffcc;
            animation: cyanType 0.6s step-end infinite; box-shadow:0 0 8px #00ffcc;
        }
        #unique-crosshair.text-input .xhair-ring-inner,
        #unique-crosshair.text-input .xhair-ring-outer,
        #unique-crosshair.text-input .xhair-axis { opacity:0; }
        @keyframes cyanType { 0%,100%{ opacity:1; } 50%{ opacity:0; } }
        #unique-crosshair.clicking .xhair-core { background:#ff3333; transform:rotate(225deg) scale(2.2); box-shadow:0 0 20px #ff0000; }
        #unique-crosshair.clicking .xhair-ring-outer { width:70px; height:70px; opacity:0.2; animation:none; }
        #unique-crosshair.clicking .xhair-ring-inner { width:50px; height:50px; opacity:0.3; animation:none; }
    `;
    document.head.appendChild(style);
    const crosshair = document.createElement('div');
    crosshair.id = 'unique-crosshair';
    crosshair.className = 'crosshair-hidden';
    crosshair.innerHTML = `<div class="xhair-core"></div><div class="xhair-ring-inner"></div><div class="xhair-ring-outer"></div><div class="xhair-axis top"></div><div class="xhair-axis bottom"></div><div class="xhair-axis left"></div><div class="xhair-axis right"></div>`;
