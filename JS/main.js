...
let _0xData = [
  ...
  { id: "t_pa", title: "Throw a Potato", url: "../Games/TAPA/index.html", image: "imgs/images%20(3).jpeg", desc: "Physics arcade game where you launch a potato over complex obstacles.", popular: true },
  { id: "t_p2", title: "Throw a Potato 2", url: "../Games/TAPA2/index.html", image: "imgs/download.jpeg", desc: "The official sequel featuring refined launch engines and bigger stages.", popular: true },
  { id: "t_to", title: "Tung Tung Tung Sahur Obby", url: "../Games/T^3sahurobby/index.html", image: "imgs/images%20(2).jpeg", desc: "Meme-inspired obstacle map built to test jumping accuracy.", popular: true },
  ...
  { id: "v_3", title: "Vex 3", url: "../Games/Vex/Vex3/index.html", image: "imgs/images%20(1).jpeg", desc: "The iconic original entry into the parkour system.", popular: true },
  ...
  { id: "gm_1", title: "Gun Mayhem", url: "../Games/GunMayhem/gunmayhem/gunmayhem.html", image: "imgs/images%20(12).jpeg", desc: "Fast-paced multiplayer arena shooter featuring powerful weapons, explosions, and chaotic battles.", popular: true },
  { id: "gm_2", title: "Gun Mayhem 2", url: "../Games/GunMayhem/gunmayhem2/gunmayhem2.html", image: "imgs/images%20(13).jpeg", desc: "The sequel to Gun Mayhem with more weapons, maps, customization, and intense combat.", popular: true },
  { id: "gm_r", title: "Gun Mayhem Redux", url: "../Games/GunMayhem/gunmayhemredux/gunmayhemredux.html", image: "imgs/images%20(14).jpeg", desc: "A remastered Gun Mayhem experience with improved gameplay, expanded content, and smoother action.", popular: true },
  ...
  { id: "a_sr", title: "Amazing Strange Rope Police", url: "../Games/ASRP/index.html", image: "imgs/images%20(22).jpeg", desc: "Open-world action game where you use superhuman abilities, vehicles, and gadgets to fight crime across a massive city.", popular: true },
  ...
  { id: "mx3", title: "Moto X3M", url: "../Games/MotoX3m/MotoX3m/index.html", image: "imgs/images%20(4).jpeg", desc: "Race through explosive obstacle courses packed with ramps, traps, and high-speed motorcycle stunts.", popular: true },
  { id: "mx3_2", title: "Moto X3M 2", url: "../Games/MotoX3m/MotoX3m2/index.html", image: "imgs/images%20(5).jpeg", desc: "The sequel featuring tougher tracks, bigger jumps, and even more dangerous stunt challenges.", popular: true },
  { id: "mx3_3", title: "Moto X3M 3", url: "../Games/MotoX3m/MotoX3m3/index.html", image: "imgs/images%20(6).jpeg", desc: "Take on intense new levels filled with hazards, precision jumps, and fast-paced motorcycle action.", popular: true },
  { id: "mx3_w", title: "Moto X3M Winter", url: "../Games/MotoX3m/MotoX3m Winter/index.html", image: "imgs/images%20(7).jpeg", desc: "A festive winter-themed Moto X3M adventure featuring snowy tracks and holiday-inspired obstacles.", popular: true },
  { id: "mx3_s", title: "Moto X3M Spooky Land", url: "../Games/MotoX3m/MotoX3m Spooky Land/index.html", image: "imgs/images%20(8).jpeg", desc: "Halloween-themed motorcycle racing with haunted tracks, creepy decorations, and dangerous traps.", popular: true },
  { id: "mx3_p", title: "Moto X3M Pool Party", url: "../Games/MotoX3m/MotoX3m Pool Party/index.html", image: "imgs/images%20(9).jpeg", desc: "Splash through water-filled stunt courses packed with slides, loops, and summer-themed challenges.", popular: true },
  ...
  { id: "er_1", title: "Escape Road", url: "../Games/Escaperoad/Escape Road/index.html", image: "imgs/images%20(15).jpeg", desc: "Outrun relentless pursuers in this high-speed driving game packed with sharp turns and daring escapes.", popular: true },
  { id: "er_2", title: "Escape Road 2", url: "../Games/Escaperoad/Escape Road 2/index.html", image: "imgs/images%20(16).jpeg", desc: "The sequel expands the action with tougher chases, new vehicles, and more intense escape routes.", popular: true },
  { id: "er_3", title: "Escape Road 3", url: "../Games/Escaperoad/Escape Road 3/index.html", image: "imgs/images%20(17).jpeg", desc: "Take on even greater challenges with faster pursuits, advanced obstacles, and nonstop driving action.", popular: true },
  { id: "erc_2", title: "Escape Road City 2", url: "../Games/Escaperoad/Escape Road City 2/index.html", image: "imgs/images%20(18).jpeg", desc: "Navigate a bustling city while evading capture through crowded streets, shortcuts, and dangerous intersections.", popular: true },
  { id: "imt", title: "Idle Miner Tycoon", url: "../Games/IMT/index.html", image: "imgs/images%20(10).jpeg", desc: "Build a mining empire from the ground up by managing resources, upgrading operations, and expanding your profits.", popular: true },
  { id: "ime_1", title: "Idle Mining Empire", url: "../Games/IME/index.html", jsbin: "https://codepen.io/Glaeesas/embed/bNgMxpg?default-tab=result&theme-id=dark", isEmbedCode: true, image: "imgs/images%20(11).jpeg", desc: "Build your mining operation from the ground up, automate production, and expand your empire to earn massive profits even while idle.", popular: true },
  { id: "dbs", title: "Double Barrel Sniper", url: "../Games/DBS/index.html", image: "imgs/images.png", desc: "Sharpen your aim in this precision sniper game featuring challenging missions, long-range shots, and tactical gameplay.", popular: true },
  { id: "dm_1", title: "Doge Miner", url: "../Games/Dogeminer1/index.html", image: "imgs/images%20(20).jpeg", desc: "Mine Dogecoins, hire Shiba workers, and upgrade your operation to reach the moon in this idle clicker game.", popular: true },
  { id: "dm_2", title: "Doge Miner 2", url: "../Games/Dogeminer2/index.html", image: "imgs/images%20(19).jpeg", desc: "The sequel expands the Dogecoin mining adventure with new upgrades, planets, and even more ways to grow your mining empire.", popular: true },
  ...
  { id: "baby_sniper_vietnam", title: "Baby Sniper in Vietnam", url: "../Games/BSV/index.html", image: "imgs/images%20(21).jpeg", desc: "Take on critical missions, hone your long-range accuracy, and clear strategic targets under the cover of dense jungle terrain in this tactical sniping simulation.", popular: true },
